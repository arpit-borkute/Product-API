...
public class ProductController {
	...
	public ResponseEntity<Boolean> saveProduct(@Valid @RequestBody Product product) { // @valid
		boolean isAdded = service.saveProduct(product);
		if (isAdded) {
			return new ResponseEntity<Boolean>(isAdded, HttpStatus.CREATED);
		} else {
			throw new ResourceAlreadyExistException("Resource Already Exists"); // for custom exception
