...
public class Product {
	...
	@NotEmpty(message = "Product Name Is Required") // @NotNull vs @NotEmpty        ----data validation
	@Column(unique = true, nullable = false)
	private String productName;

	@OneToOne
	private Supplier supplier; // custom datatype

	@OneToOne
	private Category category; // custom datatype

	@Column(nullable = false)
	@Min(1)  //data validation
